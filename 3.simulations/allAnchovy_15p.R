...
parametersData = read.csv(file = "/home1/datawork/clujanpa/sensitivity/paper_protocol/c2_15p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/c2_15p")
...
start = date()
fixed15p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/c2_15p")
saveRDS(object = fixed15p_allAnchovy, file = "fixed15p_allAnchovy.rds")
