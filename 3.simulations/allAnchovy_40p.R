...
parametersData = read.csv(file = "/home2/datawork/ipitavac/sensitivity/paper_protocol/c5_40p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c5_40p")
...
start = date()
fixed40p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c5_40p")
saveRDS(object = fixed40p_allAnchovy, file = "fixed40p_allAnchovy.rds")
