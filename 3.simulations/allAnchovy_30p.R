...
parametersData = read.csv(file = "/home2/datawork/ipitavac/sensitivity/paper_protocol/c4_30p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c4_30p")
...
start = date()
fixed30p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c4_30p")
saveRDS(object = fixed30p_allAnchovy, file = "fixed30p_allAnchovy.rds")
