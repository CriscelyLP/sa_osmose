...
parametersData = read.csv(file = "/home2/datawork/ipitavac/sensitivity/paper_protocol/c3_20p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c3_20p")
...
start = date()
fixed20p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c3_20p")
saveRDS(object = fixed20p_allAnchovy, file = "fixed20p_allAnchovy.rds")
