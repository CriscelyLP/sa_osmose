...
parametersData = read.csv(file = "/home2/datawork/ipitavac/sensitivity/paper_protocol/b3_70p_linear/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/b3_70p_linear")
...
start = date()
fixed70p_linear_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/b3_70p_linear")
saveRDS(object = fixed70p_linear_allAnchovy, file = "fixed70p_linear_allAnchovy.rds")
