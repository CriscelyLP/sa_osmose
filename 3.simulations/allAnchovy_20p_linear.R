...
parametersData = read.csv(file = "/home1/datawork/clujanpa/sensitivity/paper_protocol/b2_20p_linear/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/b2_20p_linear")
...
start = date()
fixed20p_linear_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/b2_20p_linear")
saveRDS(object = fixed20p_linear_allAnchovy, file = "fixed20p_linear_allAnchovy.rds")
