...
parametersData = read.csv(file = "/home1/datawork/clujanpa/sensitivity/paper_protocol/b3_10p_linear/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/b3_10p_linear")
...
start = date()
fixed10p_linear_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/b3_10p_linear")
saveRDS(object = fixed10p_linear_allAnchovy, file = "fixed10p_linear_allAnchovy.rds")
