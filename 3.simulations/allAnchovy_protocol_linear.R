...
parametersData = read.csv(file = "/home1/datawork/clujanpa/sensitivity/paper_protocol/b1_protocol_linear/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
                          header = TRUE, sep = ",", stringsAsFactors = FALSE)
parametersData$scale = rep("linear", dim(parametersData)[1])

# Estimation of min and max (limits of parameter distribution)
parametersData = rangeEstimation(parametersData, percentage = "range")
...
run_model = function(par, names, ...) {
  ...
  setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/b1_protocol_linear")
...
start = date()
protocol_linear_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/b1_protocol_linear")
saveRDS(object = protocol_linear_allAnchovy, file = "protocol_linear_allAnchovy.rds")
