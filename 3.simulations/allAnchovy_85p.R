...
parametersData = read.csv(file = "/home2/datawork/fhoungna/sensitivity/paper_protocol/c10_85p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/fhoungna/sensitivity/paper_protocol/c10_85p")
...
start = date()
fixed85p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/fhoungna/sensitivity/paper_protocol/c10_85p")
saveRDS(object = fixed85p_allAnchovy, file = "fixed85p_allAnchovy.rds")
