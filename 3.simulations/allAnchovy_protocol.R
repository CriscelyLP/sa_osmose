...
parametersData = read.csv(file = "/home1/datawork/clujanpa/sensitivity/paper_protocol/a1_protocol/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/a1_protocol")
...
start = date()
protocol_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/a1_protocol")
saveRDS(object = protocol_allAnchovy, file = "protocol_allAnchovy.rds")
