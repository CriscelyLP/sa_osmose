...
parametersData = read.csv(file = "/home1/datawork/clujanpa/sensitivity/paper_protocol/c1_10p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/c1_10p")
...
start = date()
fixed10p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home1/datawork/clujanpa/sensitivity/paper_protocol/c1_10p")
saveRDS(object = fixed10p_allAnchovy, file = "fixed10p_allAnchovy.rds")
