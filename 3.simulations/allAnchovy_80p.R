...
parametersData = read.csv(file = "/home2/datawork/fhoungna/sensitivity/paper_protocol/c9_80p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/fhoungna/sensitivity/paper_protocol/c9_80p")
...
start = date()
fixed80p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/fhoungna/sensitivity/paper_protocol/c9_80p")
saveRDS(object = fixed80p_allAnchovy, file = "fixed80p_allAnchovy.rds")
