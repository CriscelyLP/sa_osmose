...
parametersData = read.csv(file = "/home2/datawork/fhoungna/sensitivity/paper_protocol/c7_60p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/fhoungna/sensitivity/paper_protocol/c7_60p")
...
start = date()
fixed60p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/fhoungna/sensitivity/paper_protocol/c7_60p")
saveRDS(object = fixed60p_allAnchovy, file = "fixed60p_allAnchovy.rds")
