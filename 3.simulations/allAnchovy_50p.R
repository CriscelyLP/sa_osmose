...
parametersData = read.csv(file = "/home2/datawork/ipitavac/sensitivity/paper_protocol/c6_50p/data_perturbation/osm_parameters_allAnchovy-protocol.csv",
...
run_model = function(par, names, ...) {
  ...
  setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c6_50p")
...
start = date()
fixed50p_allAnchovy = run_experiments(X = doe, FUN = run_model, names=parametersData$parameter)
end   = date()

setwd("/home2/datawork/ipitavac/sensitivity/paper_protocol/c6_50p")
saveRDS(object = fixed50p_allAnchovy, file = "fixed50p_allAnchovy.rds")
